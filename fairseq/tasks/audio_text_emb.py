...
from fairseq.data import BinarizedAudioDataset, FileAudioDataset, JointSpeechLaBSEDataset
...
@register_task("audio_pretraining_labse", dataclass=AudioPretrainingConfig)
class AudioPretrainingLabseTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        self.datasets[split] = JointSpeechLaBSEDataset(
